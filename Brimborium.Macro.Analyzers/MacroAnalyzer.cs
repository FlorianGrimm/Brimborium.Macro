...
public class MacroAnalyzer : DiagnosticAnalyzer {
    public const string DiagnosticId = "Macro";
    ...
    private static ImmutableArray<DiagnosticDescriptor> _SupportedDiagnostics => ImmutableArray.Create<DiagnosticDescriptor>(_Rule);
    ...
    public override void Initialize(AnalysisContext context) {
        ...
        //context.RegisterSyntaxNodeAction(AnalyzeRegionDirective, SyntaxKind.EndRegionDirectiveTrivia);
    }
