...
internal static class Declare {
    private const TypeAttributes DefaultTypeAttributes = TypeAttributes.NotPublic;
    private const MemberAttributes DefaultPropertyAttributes = MemberAttributes.Public | MemberAttributes.Final;
    private const MemberAttributes DefaultFieldAttributes = MemberAttributes.Private;
    private const MemberAttributes DefaultMethodAttributes = MemberAttributes.Public | MemberAttributes.Final;
    private const MemberAttributes DefaultEventAttributes = MemberAttributes.Public | MemberAttributes.Final;
