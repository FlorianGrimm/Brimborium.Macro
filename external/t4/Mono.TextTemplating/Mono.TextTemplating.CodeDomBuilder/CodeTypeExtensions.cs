...
internal static class CodeTypeExtensions {
    ...
    private const string NotValidOnType = "This CodeMemberExtensions extension method is not valid on CodeTypeDeclaration";

    private static CodeTypeDeclaration ThrowNotValid() => throw new InvalidOperationException(NotValidOnType);
