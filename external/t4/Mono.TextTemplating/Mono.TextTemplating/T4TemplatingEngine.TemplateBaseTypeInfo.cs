...
public partial class T4TemplatingEngine {
    ...
    private class TemplateBaseTypeInfo {
        ...
        public static TemplateBaseTypeInfo FromSettings(T4TemplateSettings settings) {
        ...
        private static CodeTypeDeclaration GenerateBaseClassWithPreprocessingHelpers(string templateName, CodeDomProvider provider) {
        ...
        private static void GenerateProcessingHelpers(CodeTypeDeclaration type) {
        ...
        private static void AddToStringHelper(CodeTypeDeclaration type, CodeDomProvider provider) {
