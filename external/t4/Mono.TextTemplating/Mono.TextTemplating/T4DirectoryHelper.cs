...
#nullable enable
internal static class TempSubdirectoryHelper {
    /// <summary>
    ...
    private static readonly Func<string?, DirectoryInfo>? ClassLibsImpl;
    ...
    private static unsafe string CreateTempSubdirectoryCoreUnix(string? prefix) {
    ...
    private static unsafe extern byte* libc_mkdtemp(byte* path);
    ...
    // modified to remove deps on new/internal framework APIs
    private static unsafe string CreateTempSubdirectoryCoreWindows(string? prefix) {
    ...
    private const string IO_MaxAttemptsReached = "Reached maximum directory creation attempts";
    ...
    internal static class Kernel32 {
        ...
        private static unsafe extern bool CreateDirectoryPrivate(
            string path,
