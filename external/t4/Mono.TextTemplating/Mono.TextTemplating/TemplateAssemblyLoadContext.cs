...
internal class TemplateAssemblyLoadContext : AssemblyLoadContext {
    private readonly AssemblyLoadContext hostAssemblyLoadContext;
    private readonly string[] templateAssemblyFiles;
    private readonly ITextTemplatingEngineHost host;
    private readonly Assembly hostAssembly;
    private readonly AssemblyName codeDomAsmName;
    private readonly AssemblyName textTemplatingAsmName;
    private readonly AssemblyName hostAsmName;
