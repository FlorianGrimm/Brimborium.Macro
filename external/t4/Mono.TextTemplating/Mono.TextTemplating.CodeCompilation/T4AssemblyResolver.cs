...
internal static class T4AssemblyResolver {
    public static IEnumerable<string> GetResolvedReferences(T4RuntimeInfo runtime, List<string> references) {
        ...
        var disableRefAsms = Environment.GetEnvironmentVariable("T4_DEBUG_DISABLE_REF_ASMS") is string s && s switch {
            ...
            "n" => false,
            "no" => false,
            _ => throw new T4TemplatingEngineException($"T4_DEBUG_DISABLE_REF_ASMS env var has unknown value '{s}'")
        };
    ...
    private static string Resolve(T4RuntimeInfo runtime, string reference) {
    ...
    private static readonly Lazy<string[]> KnownNet50RefAssemblyNames = new(() => new[] {
    ...
    private static readonly Lazy<string[]> Net472DefaultAssemblyRefs = new(() => new[] {
            "mscorlib.dll",
            "System.dll",
            "System.Core.dll",
            "System.Data.dll",
    ...
    private static readonly Lazy<string[]> Net472FacadeNames = new(() => new[] {
            "Microsoft.Win32.Primitives.dll",
            "netstandard.dll",
            "System.AppContext.dll",
            "System.Collections.Concurrent.dll",
