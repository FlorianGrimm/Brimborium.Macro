...
public abstract class AssemblyLoadTests<T> : StatefulTest<T> {
    protected virtual T4TemplateGenerator CreateGenerator([CallerMemberName] string testName = null) => new();
    protected virtual void CleanupGenerator(T4TemplateGenerator generator) { }
