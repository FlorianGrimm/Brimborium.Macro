...
public readonly struct ExceptionHandlingResult<TResponse>
{
    ...
    public static readonly ExceptionHandlingResult<TResponse> NotHandled =
        new ExceptionHandlingResult<TResponse>(false, default!);
...
public abstract class MessageExceptionHandler<TMessage, TResponse, TException>
