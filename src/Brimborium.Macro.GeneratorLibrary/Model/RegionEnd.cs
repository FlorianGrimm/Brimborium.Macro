...
public record struct RegionEnd(
    ...
    public static RegionEnd Empty
        => new RegionEnd(null, new LocationTag(null, 0), SyntaxNodeType.None, null, null, null);
    ...
    public RegionEnd WithLocationTag(LocationTag locationTag) {
